...
import { Clock, ChevronLeft, ChevronRight, X, Globe, Flag, LayoutList } from 'lucide-react';
...
const EVENTS: TimelineEvent[] = [
  ...
  // ── Historia de México ─────────────────────────────────────────────────
  { id:'m1', year:-200,  title:'Teotihuacán', description:'Construcción de las pirámides del Sol y la Luna (200 a.C. – 650 d.C.).', detail:'Ciudad más grande de Mesoamérica en su época. Influenció a toda Mesoamérica. Su decadencia hacia el 650 d.C. es un misterio arqueológico.', category:'mexico', era:'Prehispánico', icon:'🏛️', ecoems:'HIS-M 6.1', keywords:['teotihuacan','piramide','prehispanico','mesoamerica','azteca'] },
  { id:'m2', year:1325,  title:'Fundación de Tenochtitlán', description:'Los aztecas fundan su capital en el lago de Texcoco.', detail:'Según la leyenda, buscaron el signo de un águila sobre un nopal con una serpiente. Tenochtitlán se convirtió en la ciudad más poblada del continente americano.', category:'mexico', era:'Prehispánico', icon:'🦅', ecoems:'HIS-M 6.1', keywords:['tenochtitlan','azteca','mexico','fundacion','lago','texcoco','mexica'] },
  { id:'m3', year:1519,  title:'Llegada de Hernán Cortés', description:'Cortés desembarca en Veracruz y avanza hacia Tenochtitlán.', detail:'Aliado con pueblos enemigos de los aztecas (tlaxcaltecas). Capturó a Moctezuma II. La Malinche fue su intérprete y consejera clave. Inició la conquista de México.', category:'mexico', era:'Conquista', icon:'⚔️', ecoems:'HIS-M 6.2', keywords:['cortes','conquista','espanoles','veracruz','moctezuma','malinche','tlaxcala'] },
  { id:'m4', year:1521,  title:'Caída de Tenochtitlán', description:'Los españoles y aliados derrumban el Imperio Azteca.', detail:'Cuauhtémoc, último tlatoani azteca, fue capturado el 13 de agosto de 1521. Esta fecha marca el inicio formal del Virreinato de Nueva España.', category:'mexico', era:'Conquista', icon:'🏰', ecoems:'HIS-M 6.2', keywords:['conquista','tenochtitlan','cuauhtemoc','azteca','espana','virreinato'] },
