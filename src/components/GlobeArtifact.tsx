...
// Alternate names (from AI props, including Spanish) → exact GeoJSON feature names
      ...
      <div className="flex flex-row min-h-[320px]">
        ...
        <div className="relative flex-[3] min-w-0 bg-slate-900/50 flex items-center justify-center p-3">
          ...
          <canvas
            ...
            style={{ aspectRatio: '1 / 1', cursor: dragging ? 'grabbing' : hoveredCountry ? 'pointer' : 'grab' }}
