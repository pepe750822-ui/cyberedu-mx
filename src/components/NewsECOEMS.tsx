...
const scoreData: Record<ScoreCategory, { title: string; subtitle: string; color: string; borderColor: string; bgColor: string; icon: React.ElementType; schools: SchoolScore[] }> = {
    enp: {
        ...
        schools: [
            ...
            { name: "ENP 9 — \"Pedro de Alba\"", code: "U606000", min: 108, difficulty: "extreme" },
            { name: "ENP 2 — \"Erasmo C. de Romo\"", code: "U608000", min: 105, difficulty: "extreme" },
            { name: "ENP 5 — \"José Vasconcelos\"", code: "U612000", min: 103, difficulty: "high" },
            { name: "ENP 1 — \"Gabino Barreda\"", code: "U614000", min: 101, difficulty: "high" },
            { name: "ENP 7 — \"Ezequiel A. Chávez\"", code: "U613000", min: 100, difficulty: "high" },
            { name: "ENP 3 — \"Justo Sierra\"", code: "U605000", min: 98, difficulty: "medium" },
            { name: "ENP 8 — \"Miguel E. Schulz\"", code: "U601000", min: 96, difficulty: "medium" },
            { name: "ENP 4 — \"Vidal Castañeda\"", code: "U611000", min: 94, difficulty: "medium" },
        ]
    },
    cch: {
        ...
        icon: School,
        schools: [
            { name: "CCH Sur", code: "U604000", min: 94, difficulty: "high" },
            { name: "CCH Oriente", code: "U609000", min: 93, difficulty: "high" },
            { name: "CCH Vallejo", code: "U607000", min: 90, difficulty: "medium" },
            { name: "CCH Azcapotzalco", code: "U602000", min: 89, difficulty: "medium" },
            { name: "CCH Naucalpan", code: "U615000", min: 84, difficulty: "accessible" },
        ]
    },
    cecyt: {
        ...
        icon: Target,
        schools: [
            { name: "CECyT 9 — \"Juan de Dios Bátiz\"", code: "I509100", min: 104, difficulty: "extreme" },
            { name: "CECyT 7 — \"Cuauhtémoc\"", code: "I507100", min: 98, difficulty: "high" },
            { name: "CECyT 6 — \"Miguel Othón de M.\"", code: "I506200", min: 95, difficulty: "high" },
            { name: "CECyT 1 — \"Gonzalo V. López\"", code: "I501100", min: 92, difficulty: "medium" },
            { name: "CECyT 2 — \"Miguel Bernard\"", code: "I502100", min: 90, difficulty: "medium" },
            { name: "CECyT 3 — \"Estanislao Ramírez\"", code: "I503100", min: 88, difficulty: "medium" },
            { name: "CECyT 4 — \"Lázaro Cárdenas\"", code: "I504100", min: 86, difficulty: "accessible" },
            { name: "CECyT 10 — \"Carlos Vallejo\"", code: "I510100", min: 85, difficulty: "accessible" },
            { name: "CECyT 11 — \"Wilfrido Massieu\"", code: "I511100", min: 84, difficulty: "accessible" },
            { name: "CECyT 12 — \"José Ma. Morelos\"", code: "I512300", min: 82, difficulty: "accessible" },
            { name: "CECyT 14 — \"Luis Enrique Erro\"", code: "I514300", min: 81, difficulty: "accessible" },
            { name: "CECyT 15 — \"Diódoro A. Guzmán\"", code: "I515200", min: 80, difficulty: "accessible" },
        ]
    }
};
