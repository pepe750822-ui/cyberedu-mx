...
export const areas: Area[] = [
  ...
  },
  {
    ...
    videoCount: 7,
    videos: [
      { id: "hm-mx-1", title: "Culturas Prehispánicas", description: "Culturas Prehispánicas. (Temario 6.1)", videoUrl: embedUrl("i624x_P0nFE"), duration: "5:00" },
      { id: "hm-mx-2", title: "Conquista de México", description: "Conquista de México. (Temario 6.2)", videoUrl: embedUrl("gYaNWsMePSI"), duration: "5:00" },
      { id: "hm-mx-3", title: "Virreinato de Nueva España", description: "Virreinato. (Temario 6.3)", videoUrl: embedUrl("HRTQQ-Bw1SU"), duration: "5:00" },
      { id: "hm-mx-4", title: "Independencia de México", description: "Independencia. (Temario 7.3)", videoUrl: embedUrl("T2Dx4S9oHis"), duration: "5:00" },
      { id: "hm-mx-5", title: "México Siglo XIX", description: "Siglo XIX. (Temario 8.1)", videoUrl: embedUrl("JtwPBC9fM4U"), duration: "5:00" },
      { id: "hm-mx-6", title: "Revolución Mexicana", description: "Revolución Mexicana. (Temario 9.1)", videoUrl: embedUrl("puhli0gtaK0"), duration: "5:00" },
      { id: "hm-mx-7", title: "México Contemporáneo", description: "México Contemporáneo. (Temario 10.1)", videoUrl: embedUrl("FzUlr0NAfXc"), duration: "5:00" },
    ],
  },
  {
    id: "espanol",
