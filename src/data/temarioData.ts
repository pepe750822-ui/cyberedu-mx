...
export const colorMap: Record<string, { header: string; dot: string; tag: string; btn: string; ring: string }> = {
  ...
  purple:  { header: "bg-purple-600",  dot: "bg-purple-400",  tag: "bg-purple-900/40 text-purple-300",  btn: "bg-purple-600 hover:bg-purple-500",  ring: "ring-purple-500/30 border-purple-500/30" },
  green:   { header: "bg-green-600",   dot: "bg-green-400",   tag: "bg-green-900/40 text-green-300",   btn: "bg-green-600 hover:bg-green-500",   ring: "ring-green-500/30 border-green-500/30" },
  ...
  orange:  { header: "bg-orange-500",  dot: "bg-orange-400",  tag: "bg-orange-900/40 text-orange-300",  btn: "bg-orange-600 hover:bg-orange-500",  ring: "ring-orange-500/30 border-orange-500/30" },
  cyan:    { header: "bg-cyan-600",    dot: "bg-cyan-400",    tag: "bg-cyan-900/40 text-cyan-300",    btn: "bg-cyan-600 hover:bg-cyan-500",    ring: "ring-cyan-500/30 border-cyan-500/30" },
  red:     { header: "bg-red-600",     dot: "bg-red-400",     tag: "bg-red-900/40 text-red-300",     btn: "bg-red-600 hover:bg-red-500",     ring: "ring-red-500/30 border-red-500/30" },
  teal:    { header: "bg-teal-600",    dot: "bg-teal-400",    tag: "bg-teal-900/40 text-teal-300",    btn: "bg-teal-600 hover:bg-teal-500",    ring: "ring-teal-500/30 border-teal-500/30" },
  pink:    { header: "bg-pink-600",    dot: "bg-pink-400",    tag: "bg-pink-900/40 text-pink-300",    btn: "bg-pink-600 hover:bg-pink-500",    ring: "ring-pink-500/30 border-pink-500/30" },
  indigo:  { header: "bg-indigo-600",  dot: "bg-indigo-400",  tag: "bg-indigo-900/40 text-indigo-300",  btn: "bg-indigo-600 hover:bg-indigo-500",  ring: "ring-indigo-500/30 border-indigo-500/30" },
};
