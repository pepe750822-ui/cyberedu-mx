...
const SimuladorPro = () => {
    ...
    return (
        ...
        {/* WhatsApp button — hidden on mobile during active exam */}
        <a
            href="https://wa.me/5215523269241"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Únete al grupo de WhatsApp"
            className={`fixed bottom-6 right-4 z-[99] no-underline flex items-center gap-2 group ${isExamActive ? "hidden md:flex" : "flex"}`}
        >
