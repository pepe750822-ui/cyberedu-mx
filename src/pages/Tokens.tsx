...
const premiumPackages = [
  ...
  },
  {
    ...
    description: "Acceso total a todo + 200 tokens para Tutor IA · Pago único",
    urgency: "La mejor inversión para tu preparación",
    perks: ["Todos los bancos desbloqueados", "44 videos Guía 2026", "Práctica por Subíndice ilimitada", "🎁 200 tokens para el Tutor IA", "⭐ Badge Todo Incluido"],
  },
];
        ...
        {user && (
          <div className="max-w-4xl mx-auto space-y-4">
            ...
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              className="glass-card-premium p-6 rounded-3xl border-green-500/20 bg-green-500/5 flex flex-col md:flex-row items-center justify-between gap-6"
            >
                <div className="flex items-center gap-5">
                    <div className="w-12 h-12 rounded-xl bg-green-500/20 border border-green-500/30 flex items-center justify-center shrink-0">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="#4ade80">
                    ...
                    <div>
                        <p className="text-[10px] font-black uppercase tracking-widest text-slate-500">Comunidad</p>
                        <h3 className="text-lg font-bold text-white">Grupo de WhatsApp CyberEdu MX</h3>
                        <p className="text-xs text-slate-400">Resuelve dudas, comparte tips y conecta con otros estudiantes.</p>
                    </div>
                </div>
                <a
                  href="https://wa.me/5215523269241"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2 w-full md:w-auto h-11 px-6 rounded-xl bg-green-500 hover:bg-green-400 text-white font-black uppercase tracking-widest text-[10px] transition-all shrink-0 no-underline"
                >
                  Únete al grupo →
                </a>
            </motion.div>
